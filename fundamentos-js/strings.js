...
console.log(escola.charAt(4)) //Retorna a letra do local da palavra
console.log(escola.charAt(5))
console.log(escola.charCodeAt(3)) //Localiza o número do código HTML na tabela unicode
console.log(escola.indexOf(2)) //Indice relacionado ao núemro da palavra
...
console.log(escola.replace(/\w/g, 'e')) //Substitui pela letra a primeira palavra." /\w/g " - (g: global) substitui tudo pela letra definida
